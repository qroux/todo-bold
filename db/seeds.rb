...
List.create(title: 'rendez vous', user_id: User.last.id, collaborators: ["#{User.last.email}"])
Task.create(name: 'a', list_id: List.last.id)
Task.create(name: 'b', list_id: List.last.id)
Task.create(name: 'c', list_id: List.last.id)

List.create(title: 'procédure', user_id: User.last.id, collaborators: ["#{User.last.email}"])
...
List.create(title: 'ma liste', user_id: User.last.id, collaborators: ["#{User.last.email}"])
Task.create(name: '1', list_id: List.last.id)
Task.create(name: '2', list_id: List.last.id)
Task.create(name: '3', list_id: List.last.id)

List.create(title: 'autre liste', user_id: User.last.id, collaborators: ["#{User.last.email}"])
